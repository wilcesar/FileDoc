...
if(isset($_POST['atualizar'])){
	...
	$update = "UPDATE usuario SET nome_tp='$nome_tp_up' WHERE id_tp = '$id'";
...
<?php 
	...
	//echo $meta;	
		...
		?>
<div class="alert alert-error">Erro com Sucesso!</div>
<?php 
	}
...
<form id="edit_usuario" name="edit_usuario" method="post" action="">
  <fieldset>
    ...
    <label>Nome</label>
    <input type="text" id="nome_tp" name="nome_tp" value="<?php echo $nome_usuario?>" >
    <br/>
