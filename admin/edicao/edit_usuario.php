...
if(isset($_POST['atualizar'])){
	...
	$slt_usuario= "SELECT * FROM usuario WHERE email_usuario = '$email_usuario_up' and id_usuario<>'$id'";
		$qry = mysql_query($slt_usuario) or die("Erro ao selecionar dados!".mysql_error());
	...
	if($senha_usuario_up == $senha_usuario2_up){
		...
		$update = "UPDATE usuario SET nome_usuario='$nome_usuario_up', email_usuario='$email_usuario_up',dtnasc_usuario='$dtnasc_usuario_up', admin_usuario = '$admin_up' WHERE id_usuario='$id'";
...
<div class="alert alert-error">E-mail já cadastrado para outro cliente!</div>
<?php 
	}
}
